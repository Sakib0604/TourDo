...
public class BarisalDivision extends base {

    CoordinatorLayout barisalDivision;
    Snackbar snackbar;
    ...
    //networkcheck
    private BarisalDivision.NetworkChangeReceiver receiver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barisalDivision = findViewById(R.id.barisalDivision);
    ...
    private boolean isNetworkAvailable(Context context) {
        ...
        snackbar.make(barisalDivision,"No Internet Connection",Snackbar.LENGTH_LONG).show();
    ...
    protected void onStart() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new MyAdapter(BarisalDivision.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(BarisalDivision.this,"Wrong...",Toast.LENGTH_LONG).show();
