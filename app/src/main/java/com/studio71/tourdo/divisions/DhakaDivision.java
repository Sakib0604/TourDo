...
public class DhakaDivision extends base {

    CoordinatorLayout dhakaDivision;
    Snackbar snackbar;
    ...
    //networkcheck
    private DhakaDivision.NetworkChangeReceiver receiver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dhakaDivision = findViewById(R.id.dhakaDivision);

        recyclerView = findViewById(R.id.myRecycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        list = new ArrayList<Model>();

        reference = FirebaseDatabase.getInstance().getReference().child("Dhaka");
    ...
    private boolean isNetworkAvailable(Context context) {
        ...
        snackbar.make(dhakaDivision,"No Internet Connection",Snackbar.LENGTH_LONG).show();
        isConnected = false;
        return false;
    }
    ...
    protected void onStart() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new MyAdapter(DhakaDivision.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(DhakaDivision.this,"Wrong...",Toast.LENGTH_LONG).show();
