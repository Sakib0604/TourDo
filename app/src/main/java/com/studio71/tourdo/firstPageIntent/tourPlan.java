...
public class tourPlan extends base {

    CoordinatorLayout coordinator_layout4;
    Snackbar snackbar;

    DatabaseReference reference;
    RecyclerView recyclerView;
    ArrayList<ModelPlan> list;
    MyAdapterPlan adapter;

    //dialog
    ProgressDialog progressDialog;

    //networkcheck
    private tourPlan.NetworkChangeReceiver receiver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coordinator_layout4 = findViewById(R.id.coordinator_layout4);

        recyclerView = findViewById(R.id.myRecycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        list = new ArrayList<ModelPlan>();

        reference = FirebaseDatabase.getInstance().getReference().child("TourPlan");
    ...
    private boolean isNetworkAvailable(Context context) {
        ...
        snackbar.make(coordinator_layout4,"No Internet Connection",Snackbar.LENGTH_LONG).show();
        isConnected = false;
        return false;
    }
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1: dataSnapshot.getChildren()){
                    ...
                    ModelPlan modelPlan = dataSnapshot1.getValue(ModelPlan.class);
                    list.add(modelPlan);
                    progressDialog.dismiss();

                }

                adapter = new MyAdapterPlan(tourPlan.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(tourPlan.this,"Wrong...",Toast.LENGTH_LONG).show();
